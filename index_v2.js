...
(async () => {
    ...
    await page.type('#MainContent_txtName', 'Sunitha Srungavarapu')
    await page.type('#MainContent_txtRegNo', 'A3246')
    await page.select('select[name="ctl00$MainContent$ddlSDC"]', 'AND')
